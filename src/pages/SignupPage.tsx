...
import { Eye, EyeOff, Calendar, Mail, Lock, User, Store, Tags, Loader } from 'lucide-react';
...
const SignupPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (accountType === 'vendor' && (!formData.shopName || !formData.vendorType)) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-amber-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">Join as a user or vendor to start booking or listing events</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {formData.accountType === 'vendor' && (
              <>
                ...
                <div>
                  <label htmlFor="vendorType" className="block text-sm font-medium text-gray-700 mb-2">Vendor Type</label>
                  <div className="relative">
            ...
            >
              {isLoading ? <Loader className="animate-spin h-5 w-5 mr-2" /> : 'Create Account'}
            </button>
          </form>
